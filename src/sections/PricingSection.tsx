            ...
            <div className="flex flex-wrap items-center justify-center gap-8 mt-20">
                {pricingData.map((plan: IPricing, index: number) => (
                    ...
                    >
                        ...
                        <a href={plan.buttonHref} className={`inline-block w-full py-2.5 rounded-md font-medium mt-7 transition-all text-center ${plan.mostPopular ? 'bg-white text-pink-600 hover:bg-slate-200' : 'bg-pink-500 hover:bg-pink-600'}`}>
                            {plan.buttonText}
                        </a>
                    </motion.div>
                ))}
